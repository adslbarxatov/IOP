...
*Ревизия №8 от 30 августа 2026 года*
...
Начиная работу с Объектами Политики и / или в Зоне действия Политики, Вы полностью соглашаетесь с данной Политикой
и принимаете её!***
...
Никаких явных или скрытых платежей и / или ограничений на Объекты Политики, а также на их исходные материалы
не предусмотрено, кроме запрета на присвоение представленных в них идей и решений. Если Объекты Политики
используют компоненты с частично бесплатными и / или менее свободными лицензиями, это отражается
...
⁽²⁾ Автоматическое обновление исполняемого контента разрешено только для магазина приложений DPArray
в качестве дополнительной функции, отключённой по умолчанию.
...
- прямые оскорбления
- издевательства
- оскорбления в отношении людей и Объектов Политики
...
⁽²⁾ Нецелевые (общего характера) рекламные элементы могут стать основанием для перманентного ограничения доступа в Зону действия Политики.
...
контент удаляется из Зоны действия Политики и из Объектов Политики.

⁽³⁾ Рекомендуется указание автора контента. Если информация об авторе отсутствует, в качестве создателя контента
...
⁽¹⁾ На территориях некоторых государств введены ограничительные законы дезинтеграционного характера, которые
несовместимы с настоящей Политикой. Лаборатория видит своей задачей избежать любых конфликтов, связанных
с этим несоответствием. Единственный способ сделать это, доступный на момент публикации данной ревизии Политики,
– сделать все Объекты Политики недоступными на этих территориях. В связи с этим был разработан **контроль XPUN**.
...
1. Регламенты сообществ имеют приоритет над Регламентами продуктов в обработке конфликтов Объектов данной Политики
   с Регламентами сообществ даже при полном соответствии остальным разделам Политики.
...
3. Публикация Объектов Политики, не соответствующих ей, в материалах, комментариях и / или новостных лентах Зоны
